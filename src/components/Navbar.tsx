    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/15 bg-white/10 backdrop-blur-xl text-white shadow-xs">
      <div className="flex h-16 items-center px-4 sm:px-6 lg:px-8 w-full max-w-[1280px] mx-auto">
        ...
        <div className="ml-auto flex items-center space-x-2.5 sm:space-x-3">
          <div className="hidden lg:flex items-center bg-white/10 border border-white/15 rounded-full px-3.5 py-1 text-xs font-semibold text-white/90 backdrop-blur-md">
